...
class qodev{
    ...
    void qubits(veci qubit, mati qmap);                                                 // Initialize the device using a qubit definition
...
public:
    ...
    *  It is possible to overlook the ignored channels definition in the circuit an maintain those channels in the output.<br>
