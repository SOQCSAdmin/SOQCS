/** \example live4.cpp
*   \brief <b>EXAMPLE 4</b>: HOM Visibility simulation of a 2x2 MMI beamsplitter.<br>
...
int main(){
    ...
    cout << "* Example 4: HOM Visibility simulation of a 2x2 MMI beamsplitter." << endl;
    cout << endl;

    // Create objects
    hterm in_term;
    in_term.resize(1,2);
    auto example = new qodev(2,2,1,2,1,0.0,0,10000,true,'G',1);
