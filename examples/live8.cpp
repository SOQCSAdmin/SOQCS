/** \example live8.cpp
*   \brief <b>EXAMPLE 8</b>: Entanglement swapping protocol using a physical quantum dot as a non-ideal Bell emitter.<br>
...
int main()
{
    cout << "* Example 8: Entanglement swapping protocol" << endl;
    cout << endl;

    // Create simulation structures
    auto example = new qodev(4,3,2,4,1,0.0,1,0,false,'E',4);
    ...
    for(int i=0;i<N;i++){
        ...
        // build circuit
        example->reset();
        example->add_QD(0, 1,  0.0, 10000.0, 1.0, 46.71, 10000.0, 1.0, 1.0, 0.8, 1.0, 1.0,0);
        example->add_QD(0, 2, 16.0, 10000.0, 1.0,  46.5, 10000.0, 1.0, 1.0, 0.8, 1.0, 1.0,0);
